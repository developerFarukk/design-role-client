...
//                                     <input
//                                         type='url'
//                                         {...register("liveLink", { required: "liveLink is required" })}
...
const CreateProject = () => {
    ...
    const onSubmit: SubmitHandler<FieldValues> = async (data) => {
        ...
        const formData = new FormData();
        formData.append('data', JSON.stringify(projectData));
        formData.append('file', data.image[0]); // Ensure the file is correctly appended

        console.log("Form Data:", Object.fromEntries(formData)); // Debugging: Log form data
