                ...
                <div className="mx-auto   pb-2 pt-8">
                    <div className="mx-auto max-w-md">
                        ...
                        <form className="mt-6">
                            <div className="relative max-w-lg">
                                ...
                                <input
                                    className="w-full rounded-full border-blue-400 border-2 p-4 pe-32 text-sm font-medium"
                                    id="email"
                                    type="email"
                    ...
                    <div className="mt-4 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
                        <div className="mx-auto max-w-sm lg:max-w-none">
                            <p className="mt-4  text-left  lg:text-lg">
                                Hi, I am omar faruk .  Full-stack developer
                            </p>
